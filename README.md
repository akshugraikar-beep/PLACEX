# PlaceX by Innovision Technologies Pvt Ltd - GSSoC 2025

![GSSoC 2025](https://img.shields.io/badge/GSSoC-2025-blue.svg)
![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)
![Status: Active](https://img.shields.io/badge/status-active-success.svg)
[![GitHub issues](https://img.shields.io/github/issues/MonishRaman/PlaceX-Smarter_Placements-Sharper_Talent)](https://github.com/MonishRaman/PlaceX-Smarter_Placements-Sharper_Talent/issues)
![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)
![Open PRs](https://img.shields.io/github/issues-pr/MonishRaman/PlaceX-Smarter_Placements-Sharper_Talent)
![Closed PRs](https://img.shields.io/github/issues-pr-closed/MonishRaman/PlaceX-Smarter_Placements-Sharper_Talent)
[![GitHub forks](https://img.shields.io/github/forks/MonishRaman/PlaceX-Smarter_Placements-Sharper_Talent)](https://github.com/MonishRaman/PlaceX-Smarter_Placements-Sharper_Talent/network)
[![GitHub stars](https://img.shields.io/github/stars/MonishRaman/PlaceX-Smarter_Placements-Sharper_Talent)](https://github.com/MonishRaman/PlaceX-Smarter_Placements-Sharper_Talent/stargazers)
[![Join our Discord](https://img.shields.io/badge/Join_Discord-7289DA?logo=discord&logoColor=white)](https://discord.gg/WdAdQPAB)
![Top Language](https://img.shields.io/github/languages/top/MonishRaman/PlaceX-Smarter_Placements-Sharper_Talent)
![Last Commit](https://img.shields.io/github/last-commit/MonishRaman/PlaceX-Smarter_Placements-Sharper_Talent?logo=github)
![Commit Activity](https://img.shields.io/github/commit-activity/m/MonishRaman/PlaceX-Smarter_Placements-Sharper_Talent?color=blue)
![Monthly Commits](https://img.shields.io/github/commit-activity/m/MonishRaman/PlaceX-Smarter_Placements-Sharper_Talent?color=green)
![Weekly Commits](https://img.shields.io/github/commit-activity/w/MonishRaman/PlaceX-Smarter_Placements-Sharper_Talent?color=yellow)

Welcome to the official repository for **PlaceX**, a project by **Innovision Technologies Pvt Ltd**, participating in **GirlScript Summer of Code (GSSoC) 2025**. We're thrilled to have you join our mission!
...
🔗 **[PlaceX Live App](https://PlaceXapp.netlify.app/)**
...
🚀 This project is now an official part of GirlScript Summer of Code – GSSoC'25! 💻 We're thrilled to welcome contributors from all over India and beyond to collaborate, build, and grow *PlaceX-Smarter_Placements-Sharper_Talent!* Let’s make learning and career development smarter – together! 🌟
...
🎉 **I can’t wait to welcome new contributors** from GSSoC 2025 to this PlaceX-Smarter_Placements-Sharper_Talent project family! Let's build, learn, and grow together — one commit at a time. 
...
- [💡 The Solution: PlaceX](#-the-solution-PlaceX)
...
**PlaceX** is an AI-powered, full-stack assessment platform that automates and elevates the campus placement process. It mimics real interviews and evaluates candidates on:
...
PlaceX-Smarter_Placements-Sharper_Talent/<br>
...
Want to run PlaceX on your local machine? Here’s how 👇
...
```bash
git clone https://github.com/your-username/PlaceX-Smarter_Placements-Sharper_Talent.git
```

3. **Navigate into the project directory**:

```bash
cd PlaceX-Smarter_Placements-Sharper_Talent
```
...
```bash
git remote add upstream https://github.com/MonishRaman/PlaceX-Smarter_Placements-Sharper_Talent.git
git fetch upstream
git checkout main
